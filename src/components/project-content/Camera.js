  ...
  return (
    <div className="project-content-container" id="camera-project-content-container">
      ...
      <div className="project-content-container-section project-design">
        <h1>Design</h1>
        <p>The IR camera housing would be a removeable module that could slide into small grooves on a custom 3D-printed phone case. To maintain the slim form factor of a smartphone phone, I designed the IR camera module housing to be just a few millimeters thick.</p>
        ...
        <p>To keep the IR camera module as small and simple as possible, the main electronic components—Raspberry Pi Zero W, NoIR V2 Camera, and TNTOR Ultra Thin Power Bank—were press tightly together in a case with connecting pegs to secure the module cover, removing the need for any fasteners.</p>
      </div>
