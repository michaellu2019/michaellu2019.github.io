  ...
  return (
    <div className="project-content-container" id="krabs-project-content-container">
      <div className="project-content-container-section project-overview">
        <h1>Overview</h1>
        <p>Kombat Krabs was a set of remote-controlled toy robot crabs that walked using Jansen's linkage (of kinetic sculptor Theo Jansen). These Krabs were built primarily out of foam core, paper, and cardboard to meet the $20 additional material constraint of the class (2.00B - Toy Product Design) for which they were made.</p>
        <img src={krabsCover} />
      </div>
      ...
      <div className="project-content-container-section project-design">
        <h1>Design</h1>
        <p>Using Jansen’s Linkage, multiple legs could be driven by one motor. Thus, a Krab with eight legs would have two motors—one motor to control the left set of legs, and another motor to control the right set of legs. This would allow the Krabs to move straight and turn.</p>
        <p>A pair of legs would be attached to one side of the motor and would be driven by a common drive shaft turned by the motor so that their walking curve trajectories would be out of phase by 180°. The other pair of legs driven by the motor would also have its drive shaft rotated to be 180° from the other drive shaft.</p>
        <div className="image-next-to-container">
      ...
      <div className="project-content-container-section project-programming">
        ...
        <p>By programming the Krab's Arduino microcontroller, I was able to drive the Krab so that it could move sideways and turn on the spot by controlling the speed and direction of one or both set of legs.</p>    
        <p>After connecting a set of five push-buttons to the Arduino, I was able to teleoperate the Krab with a tethered remote to make it walk around and move its arm.</p>
      </div>
