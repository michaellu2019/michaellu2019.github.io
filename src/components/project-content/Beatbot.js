  ...
  return (
    <div className="project-content-container" id="beatbot-project-content-container">
      <div className="project-content-container-section project-overview">
        <h1>Overview</h1>
        <p>The BeatBot was an autonomous line-following car that paced long distance runners along a running track. This was a prototype I built for product design firm <a href="https://www.10xbeta.com/" rel="noreferrer" target="_blank">10XBeta</a> as a second version for the original PUMA BeatBot built by 10XBeta, JWT, and PUMA in 2016.</p>
        <img alt="" src={beatbotCover} />
      </div>

      <div className="project-content-container-section project-ideation">
        <h1>Ideation</h1>
        <img alt="" src={beatbotChassis} />
      ...
      <div className="project-content-container-section project-fabrication">
        ...
        <div className="image-next-to-container">
          <div className="image-container"><img alt="" src={beatbotWheel} /></div>
          <div className="image-container"><img alt="" src={beatbotCar} /></div>
        </div>
