  ...
  return (
    <div className="project-content-container" id="light-project-content-container">
      <div className="project-content-container-section project-overview">
        <h1>Overview</h1>
        <p>Designed to tackle the difficulty that certain operating rooms have with getting reliable electricity, this electronics control module was able to switch between wall power, solar power, and  battery power in milliseconds to power operating room lights. This device served as a proof-of-concept prototype for the MIT class 2.75 - Medical Device Design.</p>
      ...
      <div className="project-content-container-section project-ideation">
        ...
        <p>The impetus for the project came from the fact that certain operating rooms across the world might face blackouts and brownouts when performing critical surgeries, thus requiring robust surgical lights that could seamlessly switch to backup power sources. The following power states were devised to cover the requirements of the control module device:</p>
          ...
          <div>
            <p>
              <ol>
                ...
                <li>If only solar power is available, it is used to charge a battery, and the battery powers the lights.</li>
      ...
      <div className="project-content-container-section project-design">
        ...
        <p>These requirements served as a framework to design a modular system with five custom PCBs screwed onto a main board (so that faulty modules could be swapped out for new ones). These modules included a boost converter to step up rectified 12V DC power (from the wall) to 24V, a buck converter to take 24V (from either the boost converter of solar power) to charge a lead-acid battery at a variety of voltages, a power switching board that uses an automotive relay to switch between battery and wall power, a status UI module to display the current status of the system, and a logic module with a Raspberry Pi Pico to control individual modules.</p>
        
        <div className="image-next-to-container">
          <div className="image-container"><img alt="" src={lightSpreadsheet} /></div>
          <div>
            <p>I worked on designing a boost converter to step 12V up to 24V for the battery-charging buck converter. The specifications and component sizes for the boost converter were devised in a spreadsheet with switching losses being taken into consideration.</p>
          </div>
        </div>
      </div>
      ...
      <div className="project-content-container-section project-fabrication">
        <h1>Fabrication</h1>
        <p>The module PCBs were designed to use electrical parts widely available in most supply chains. Socketed ICs were used when possible, in case parts needed to be replaced. The boost converter featured 3 MOSFETs, each driven by a push-pull BJT drive. These BJTs were fed a 250 kHz square wave from a TL494 chip, which also had inputs for voltage and current feedback as well as overvoltage protection.</p>
        ...
        <ul>
          ...
          <li>5 × PMEG045V150EPD Schottky Diodes</li>
          <li>3 × AOT240L N-Channel MOSFETs</li>
          <li>4 × BC327 PNP Transistors</li>
          <li>3 × BC337 NPN Transistors</li>
          <li>1 × 5mR Shunt Resistor</li>
          <li>1 × 12A Fuse</li>
          <li>2 × 470 μF Radial Electrolytic Capacitors</li>
          <li>2 × 220 μF Radial Electrolytic Capacitors</li>
          <li>1 × 68 μH Radial Electrolytic Capacitor</li>
          <li>2 × Trim Potentiometers</li>
      ...
      <div className="project-content-container-section project-improvements">
        ...
        <ul>
          <li>The voltage and feedback circuits for the boost converter could have been tuned better, which sometimes caused instability based on the boost converter load. Picking different values for some of the passive elements in the feedback network might have mitigated this result.</li>
