  ...
  return (
    <div className="project-content-container" id="car-project-content-container">
      ...
      <div className="project-content-container-section project-programming">
        ...
        <img src={carStop} /> 
        <p>In addition, the YOLO was deployed on the car to identify stop signs so that the car would stop if one was within view.</p>
      </div>
      
      <div className="project-content-container-section project-results">
        <h1>Results</h1>
        <p>With all the software implemented, the car was able to complete a full lap around the indoor track as well as navigate through the mini city built for the class.</p>
        <video controls>
