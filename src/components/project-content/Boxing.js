  ...
  return (
    <div className="project-content-container" id="boxing-project-content-container">
      <div className="project-content-container-section project-overview">
        <h1>Overview</h1>
        <p>IoT boxing was an "Internet of Things" (IoT) version of the iconic Wii Sports boxing game that uses an ESP32 WiFi MCU and accelerometer to send real time punch motion data over WebSockets to an online 3D boxing game. It was made as a final project for the MIT class 6.08 - Intro to EECS via Interconnected Embedded Systems.</p>
        <img src={boxingCover} />
      </div>

      <div className="project-content-container-section project-ideation">
        <h1>Ideation</h1>
        <img src={boxingSketch} />
        <p>To give the player the most immersive boxing experience, the game had the electronics inside a pair of boxing gloves and a sports vest. The boxing gloves would hold the MPU6050 accelerometers to detect punch movements in real time, and the main electronics, such as the ESP32 and TNTOR Ultra Thin Power Bank, would be mounted inside the sports vest.</p>
      </div>
      ...
      <div className="project-content-container-section project-fabrication">
        ...
        <img src={boxingGlove} />
        <p>To minimize the electronics and weight in the boxing gloves, the MPU6050s in the boxing gloves were wired to the heavier components—the ESP32 and TNTOR Ultra Thin Power Bank—in the sports vest. This would allow the player to throw punches without feeling the added weight of the electronics.</p>
        <img src={boxingVest} />
        <p>Hardware:</p>
        <ul>
      ...
      <div className="project-content-container-section project-programming">
        <h1>Programming</h1>
        <p>The ESP32 firmware processed the acceleration data from the player’s punches and sent them to a Python WebSockets server, which forwarded it to the game website. Written in HTML, CSS, and JavaScript (using Three.js for graphics and Cannon.js for physics), the game website would control a 3D model of a boxer based on the received movements and would also save player scores in a backend database.</p>    
        <img src={boxingDiagram} />
        ...
        <img src={boxingGameStateMachine} />
      </div>
      
      <div className="project-content-container-section project-results">
        <h1>Results</h1>
        <p>With all electrical, mechanical, and software components integrated together, we were able to create an IoT boxing game where a player could compete against a computer or another player in real-time to see who could throw the best punches.</p>
