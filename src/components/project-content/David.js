  ...
  return (
    <div className="project-content-container" id="david-project-content-container">
      ...
      <div className="project-content-container-section project-design">
        ...
        <p>As the simulation progressed and the turtles evolved, the turtles that got closer to the jellyfish faster would have more offspring that would replicate their moves, thus advancing the population as a whole.</p>
      </div>
      ...
      <div className="project-content-container-section project-programming">
        ...
        <p>Because I wanted to push turtles to get closer to the jellyfish in the vertical direction first (due to the nature of the obstacle course), their vertical distance was squared to penalize large vertical distance deviations. In addition, the number of moves was counted by <i>m</i>. All these terms were scaled by weights <i>W<sub>p</sub> = 2.0</i> and <i>W<sub>v</sub> = 0.1</i> so that turtles that got closer to the goal would be rewarded a lot more. Another score weighing term <i>C = 100000000.0</i> was divided by the sum of all those terms so that turtles with small <i>x</i> and <i>y</i> distance from the jellyfish using a smaller <i>m</i> number of moves would get a higher score.</p>
      ...
      <div className="project-content-container-section project-results">
        <h1>Results</h1>
        <p>After tuning the parameters of the scoring function and tweaking the genetic algorithm, a turtle from the population was able to reach the jellyfish within 101 generations. While certainly not the quickest way to reach the jellyfish, it was cool to see how a population of randomly moving turtles would eventually reach their goal with a little push from a mother-nature-esque algorithm.</p>
