  ...
  return (
    <div className="project-content-container" id="donkey-project-content-container">
      <div className="project-content-container-section project-overview">
        <h1>Overview</h1>
        <p>The robot donkey was a WiFi-controlled quadruped that walked using inverse kinematics. The robot had four legs, each with 3-degrees-of-freedom (DOF), a 2-DOF neck/head, and two mini speakers for audio output. The robot was built as a personal project to emulate quadruped locomotion.</p>
        <img src={donkeyCover} />
      </div>
      ...
      <div className="project-content-container-section project-ideation">
        ...
        <p>To build a 12-DOF quadruped and manipulate its orientation and position, I had to figure out how to pass in a 3D position and translate it into a set of angles for the servos to rotate to. Inverse kinematics would provide an easy way to calculate these values.</p>
        ...
        <div className="image-next-to-text-container">
      ...
      <div className="project-content-container-section project-design">
        <h1>Design</h1>
        <p>The robot donkey was designed for ease-of-assembly, so parts were selected such that minimal custom parts would have to be fabricated (especially during the COVID-19 pandemic, when most maker spaces and machine shops were closed).</p>
        <p>This was why high-torque HobbyPark servos that came with aluminum mounting brackets were chosen, as it made it easy to assemble four 3-DOF legs around a main wooden body with servo parts "straight out of the box."</p>
        <p>For the robot’s feet, I used Autodesk Inventor to design four 3D-printed ball-point hooves that could be fastened to the servo brackets and were covered with rubber tips for more traction with the ground.</p>
        <img src={donkeyCAD} />
      </div>
      ...
      <div className="project-content-container-section project-programming">
        ...
        <p>The <a href="https://github.com/michaellu2019/dog" target="_blank">software</a> was split into several modules. One module was defined all robot constants, another module was used for all vector-mathematics, one module was used to calculate inverse kinematics and write values to the servo motors, and the final module took in keyboard commands to control the robot.</p>
      ...
      <div className="project-content-container-section project-results">
        <h1>Results</h1>
        <p>Eventually, I was able to program a tele-operated quadruped donkey that could walk in all directions and manipulate it's body quite smoothly. I also programmed the Raspberry Pi to play audio clips through the robot's mini speakers.</p>
