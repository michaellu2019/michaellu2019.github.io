  ...
  return (
    <div className="project-content-container" id="ninja-project-content-container">
      ...
      <div className="project-content-container-section project-ideation">
        ...
        <p>The idea for the project was inspired by the mobile game <a rel="noreferrer" target="_blank" href="https://en.wikipedia.org/wiki/Fruit_Ninja">"Fruit Ninja"</a> that was popular in the 2010s. In this game, fruits would by thrown up in the air, and the player would wield a sword to slice them in mid-air for points. This project aimed to replicate that gameplay in a Drake simulation with a robot arm.</p> 
