  ...
  return (
    <div className="project-content-container" id="ball-project-content-container">
      ...
      <div className="project-content-container-section project-fabrication">
        ...
        <p>Unfortunately, the ball was not uniform thickness (likely due to being blow molded) and was brittle in certain areas. Because of the formation of a few cracks during fabrication, the acrylic globe would eventually have to be reinforced on the inside with a layer of fiberglass and epoxy (inspired by techniques used in making boat hulls!).</p>
        ...
        <p>The head of BB-8 would stay attached to the body with the help of two pairs of strong neodymium magnets press-fit and glued into two 3D-printed magnet mounts that were shaped to conform with the curvature of the 20" ball. The magnet mount in the ball was attached to a threaded rod that was spun by a continuous rotation goBilda 25-3 speed servo. The magnet mount in the head was attached to another threaded road that fastened to the Styrofoam hemisphere structure. This rod spun freely inside the bearings of a tripod-like structure that would roll on top of the ball. The rollers shown in the picture were eventually replaced with caster wheels to reduce friction.</p>
