  ...
  return (
    <div className="project-content-container" id="competition-project-content-container">
      ...
      <div className="project-content-container-section project-design">
        ...
        <p>The lifting mechanism (pictured on the left) I designed was a belt-driven cascading elevator lift with three 14" stages. Because of three separate belts were coupled together, each stage would rise and lower simultaneously, allowing for up to 31" of lift in less than 4 seconds with no load. In addition, because a belt was used instead of a cable, the mechanism was able to both lift up and pull down, so it could be reused for different game objectives</p>
        <p>The winch mechanism was a detachable machine that would be deployed by the main robot to pull the pulley weight. This allowed the for the completion of the game objective while the main robot could drive off and complete other tasks, saving time. The winch consisted of two high-torque DC motors coupled together, driving a giant rotating hook that would grab the weight handle and wind up the pulley rope.</p>
        <div className="image-next-to-container">
          <div className="image-container"><img src={competitionChassisCAD} /></div>
          <div className="image-container"><img src={competitionFEA} /></div>
        </div>
        <p>The robot chassis was modeled to be a tank chassis with 6mm timing belt as treads to give it the most traction as it would climb up and down the competition field hill.</p>
        <p>Using Solidworks also allowed me to perform stress analysis on load-bearing components of the robot’s chassis as well as analysis of the robot’s mass properties to determine its center of gravity. These simulation tools were useful in anticipating any performance issues with the robot assembly.</p>
      </div>
      ...
      <div className="project-content-container-section project-fabrication">
        ...
        <p>Since the cascade lift also had to pull down a pendulum weight, a passively retractable hook was attached to the top. When the robot was pushed into the weight it needed to lift, the hook would be pushed in to lie flush with the weight. However, when pulling down, the hook be pulled out by an elastic band and would hit a hard stop to prevent it from rotating as the weight handle was pulled. This simple design removed the need to add an additional actuator.</p>
        <p>Since the 6mm timing belts would loosen over time, I added spring-loaded idler to keep the belt teeth engaged to the pulley. A spring-loaded idler was necessary since the the idler needed to apply more tension as the lift was higher up (as the bracket the fastened the driving belt to the next stage was farther away, so the belt became more floppy near the drive pulley).</p>
        <div className="image-next-to-container">
